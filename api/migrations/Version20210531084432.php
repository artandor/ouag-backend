...
final class Version20210531084432 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE library_shared_with_users (library_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(library_id, user_id))');
        $this->addSql('CREATE INDEX IDX_A9AD7CE8FE2541D7 ON library_shared_with_users (library_id)');
        $this->addSql('CREATE INDEX IDX_A9AD7CE8A76ED395 ON library_shared_with_users (user_id)');
        ...
        $this->addSql('ALTER TABLE library_shared_with_users ADD CONSTRAINT FK_A9AD7CE8FE2541D7 FOREIGN KEY (library_id) REFERENCES library (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE library_shared_with_users ADD CONSTRAINT FK_A9AD7CE8A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE planning ADD CONSTRAINT FK_D499BFF6EA9FDD75 FOREIGN KEY (media_id) REFERENCES media_object (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE library_shared_with_users');
